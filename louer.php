...
$lib = intval ($_GET['libelle']);
$ty = intval ($_GET['libelleT']);
$message = "";
$message = "";
$message = "";
...
<body class="">
      ...
      <main class="form-signin d-flex justify-content-center mt-4">
            <form class="container w-50 pt-3 border mt-5 rounded" method="POST" action="">
                  ...
                  <div class="mt-2 mb-3">
                        <input type="date" name="<?php $lib ?>" class="form-control" id="" placeholder="<?php $lib ?>">
                  </div>
                  <div class="mt-2 mb-3">
                        <input type="date" name="<?php $ty ?>" class="form-control" id="" placeholder="<?php $ty ?>">
                  </div>
                  <div class="mt-2 mb-3">
